    ...
    <div id="unlock-account" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form class="form" method="post" action="{{ route('user.unlock') }}">
                    @csrf
                    ...
                    <div class="modal-footer text-right">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="w-4 h-4" data-lucide="save"></i>&nbsp; &nbsp;Desbloquear</button>
                    </div>
                </form>
            </div>
        </div>
