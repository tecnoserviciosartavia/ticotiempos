        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                ...
                <div class="my-auto">
                    ...
                    <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-slate-400">Para obtener una cuenta puedes comunicarte con<br> soporte@ticotiempos.com</div>
                </div>
            </div>
            <!-- END: Login Info -->
            <!-- BEGIN: Login Form -->
            ...
            async function login() {
                ...
                axios.post(`login`, {
                    ...
                    if (err.response.data.message != 'Wrong email or password.') {
                        if (err.response.data.message == "Su usuario no puede acceder al sistema.") {
                           location.reload();
                        }
