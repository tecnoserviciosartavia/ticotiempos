            ...
            <div class="modal-content">
                    ...
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                        <div class="col-span-12">
                            <label for="pos-edit-form-5" class="form-label" style="margin-right: 11px;">Monto</label>
                            <input id="pos-edit-form-5" name='monto' type="number" class="form-control w-60 ml-6 text-center" placeholder="Monto" value="" require>
                        </div>
                        <div class="col-span-12">
                            <label for="pos-edit-form-4" class="form-label">Numero</label>
                            <input id="pos-edit-form-4" type="text" name='numero' class="form-control w-60 ml-6 text-center" placeholder="Numero" value="" min='0' max='99' require>
                        </div>
                    ...
                    <div class="modal-footer text-right">
                        ...
                        <button type="button" class="btn btn-primary" id='agregarJugadaedit'><i class="w-4 h-4" data-lucide="save"></i>&nbsp; &nbsp;Guardar</button>
                    </div>
                </form>
            </div>
        </div>
